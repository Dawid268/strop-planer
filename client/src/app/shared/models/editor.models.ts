...
/** Shape visual and metadata properties */
export interface ShapeProperties {
  ...
  width?: number;
  length?: number;
  /** Marks shapes created by auto-generation */
  isGenerated?: boolean;
...
export interface Shape {
  ...
  height?: number;
  properties?: ShapeProperties; // Visual and metadata properties
...
/** Reference geometry data structure for snapping points */
export interface ReferenceGeometryData {
  polygons?: Array<Point[] | { points: Point[] }>;
...
export interface EditorState {
  ...
  referenceGeometry?: ReferenceGeometryData | null; // Data for snapping
  viewMode: ViewMode;
